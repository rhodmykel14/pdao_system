                  ...
                  <div class="row">
                    <div class="col">
                        <div class="form-check form-check-radio">
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="pwd_user" id="newPWD" value="1" >
                                New Applicant
                                <span class="form-check-sign"></span>
                            </label>
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="pwd_user" id="oldPWD" value="2">
                                Renewal
                                <span class="form-check-sign"></span>
                            </label>
                        </div>                        
                    ...
                    <div class="col-md-5 pr-1">
                      <div class="form-group">
                        <label>Person with Disability Number</label>
                        <input type="text" class="form-control" disabled="" placeholder="pwdNumber" value="RR-PPMM-BBB-NNNNNNN">
                      </div>
                    </div>
                    <div class="col">
                      <div class="form-group">
