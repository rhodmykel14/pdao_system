...
/*if (isset($_GET['id'])){
  $id=$_GET['id'];
  $update=mysqli_query($connn,"UPDATE SET 'pwd' WHERE 'id'='$id'");
}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="pwdNumber" name="pwdNumber" placeholder="RR-PPMM-BBB-NNNNNNN" value="<?php echo $pwd['pwdNumber']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <label for="dateApplied">Date Applied</label>
                                        <input type="date" class="form-control" id="dateApplied" name="dateApplied" placeholder="date" value="<?php echo $pwd['dateApplied']; ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="lastName" name="lastName" value="<?php echo $pwd['lastName']; ?>" placeholder="">
                                    </div>
                                </div>
