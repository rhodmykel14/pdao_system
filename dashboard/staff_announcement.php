              ...
              <div class="card-body">
                <div class="panel panel-default">
                  <div class="panel-body">
                    <form action="../controller/announcementControllerStaff.php" method="POST" enctype="multipart/form-data">
                      <div class="row">
                      ...
                      <div class="row">
                        <div class="col-md-4 pr-1">
                          <button class="btn btn-primary" type="submit" name="saveAnnouncement">Submit</button>
                        </div>
                      </div>
                    </form>
                  </div>
                      ...
                      ?>
                        ...
                        <form action="../controller/deleteAnnouncementController.php" method="post">
                          <button type="button" rel="tooltip" class="btn btn-success btn-sm btn-icon">
                            ...
                            <button type="submit" rel="tooltip" class="btn btn-danger btn-sm btn-icon" onclick="return confirm('Are you sure you want to delete this announcement?');">
